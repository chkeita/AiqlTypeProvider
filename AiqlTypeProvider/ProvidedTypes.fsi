...
namespace ProviderImplementation.ProvidedTypes
    ...
    type ProvidedMethod =
        ...
        new: isTgt: bool * methodName: string * attrs: MethodAttributes * parameters: ProvidedParameter[] * returnType: Type * invokeCode: (Expr list -> Expr) option * staticParams:list<ProvidedStaticParameter> * staticParamsApply:Option<string -> obj -> MethodInfo> * customAttributesData: (unit -> CustomAttributeData[])
    ...
    type ProvidedProperty =
        ...
        new: isTgt: bool* propertyName: string* attrs: PropertyAttributes* propertyType: Type* isStatic: bool* getter: (unit -> MethodInfo) option* setter: (unit -> MethodInfo) option* indexParameters: ProvidedParameter[]* customAttributesData: unit -> CustomAttributeData[]
